const terminalLines = [
  ...
  { command: "stack --current", output: "Frontend + Backend + Databases" },
  {
    command: "building --next",
    output: "Modern web projects with clean code",
  },
...
export function TerminalCard() {
  return (
    <div className="terminal-card hud-corners min-w-0 overflow-hidden rounded-lg border border-cyan-300/20">
