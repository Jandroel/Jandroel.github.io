...
export function TimelineItem({ item, index }: TimelineItemProps) {
  ...
  return (
    ...
    >
      <span className="absolute left-1 top-6 z-10 flex size-9 items-center justify-center rounded-lg border border-cyan-300/25 bg-[#080A12] text-cyan-100 shadow-[0_0_24px_rgba(6,182,212,0.16)] sm:left-[7px] sm:size-10">
