...
export function Contact() {
  ...
  return (
    ...
    >
      <Container>
        <Reveal>
          <div className="shoji-screen relative min-w-0 overflow-hidden rounded-lg border border-[rgba(232,74,42,0.22)] bg-[linear-gradient(135deg,rgba(232,74,42,0.13),rgba(216,168,79,0.085),rgba(104,184,173,0.1))] p-5 shadow-[0_0_72px_rgba(232,74,42,0.085)] sm:p-8 lg:p-10">
            <div
              aria-hidden="true"
              className="absolute inset-0 bg-[linear-gradient(120deg,rgba(255,248,239,0.06),transparent_42%),linear-gradient(240deg,rgba(232,74,42,0.065),transparent_48%)]"
            />
            <div
              aria-hidden="true"
            ...
            <div className="relative grid min-w-0 gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.72fr)] lg:items-center">
              <div className="min-w-0 max-w-3xl">
                <div className="flex min-w-0 flex-wrap items-center gap-3">
                  ...
                  <span className="max-w-full break-all rounded-md border border-[rgba(141,156,114,0.26)] bg-[rgba(141,156,114,0.095)] px-2 py-1 font-mono text-xs text-[#dbe7bd]">
                    {t.contact.chip}
                  </span>
                </div>
                <h2
              ...
              <Card
                variant="subtle"
                className="hud-corners min-w-0 border-[rgba(232,74,42,0.16)] bg-black/20 p-4 sm:p-5"
              >
                <div className="space-y-4 font-mono text-sm">
                  ...
                  <div className="grid min-w-0 gap-1 sm:flex sm:items-center sm:justify-between sm:gap-4">
                    ...
                    <span className="break-words text-green-200">
                      {t.contact.info.statusValue}
                    </span>
                  </div>
                </div>
              </Card>
